...
public class config {
    ...
    /**
     * 0 - Mensch verwendet das linke Feld <br>
     * 1 - KI verwendet das linke Feld <br>
     * 2 - Multiplayer
     */
    public static int SpielFeld1 = 0;

    /**
     * 0 - Mensch verwendet das rechte Feld <br>
     * 1 - KI verwendet das rechte Feld <br>
     * 2 - Multiplayer
     */
    public static int SpielFeld2 = 1;

    /**
     * True: Wenn man Online als Computer spielt
     * False: Wenn man Online als Mensch spielt
     */
    ...
    /**
     * Spieldatei die geladen wird, wenn man das Spiel hostet.<br>
     * Alternativ leer, wenn keine Datei geladen werden soll.
     */
